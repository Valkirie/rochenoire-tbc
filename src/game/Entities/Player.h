...
class Player : public Unit
{
    ...
    public:
        ...
        **/
		...
		uint32 HasScaledItemCount(uint32 item, uint32 count = 1, bool inBankAlso = false) const;
        ...
        uint32 GetQuestLevelForPlayer(Quest const* pQuest, bool min = false) const;
        ...
        void SendQuestReward(Quest const* pQuest, Object* questGiver, uint32 reward, uint32 XP, uint32 honor) const;
