...
class PlayerMenu
{
    ...
    public:
        ...
        void SendGossipMenu(uint32 TitleTextId, ObjectGuid objectGuid, Player* pPlayer = nullptr);
        ...
        void SendQuestGiverQuestList(QEmote eEmote, const std::string& Title, ObjectGuid npcGUID, const Player *pPlayer = nullptr);
