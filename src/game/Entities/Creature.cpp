    ...
    switch (GetCreatureInfo()->TrainerType)
    {
        case TRAINER_TYPE_CLASS:
            if (pPlayer->getClass() != GetCreatureInfo()->TrainerClass)
            {
                if (msg)
                {
                    ...
                    {
                        case CLASS_DRUID:  pPlayer->GetPlayerMenu()->SendGossipMenu(4913, GetObjectGuid(), pPlayer); break;
                        case CLASS_HUNTER: pPlayer->GetPlayerMenu()->SendGossipMenu(10090, GetObjectGuid(), pPlayer); break;
                        case CLASS_MAGE:   pPlayer->GetPlayerMenu()->SendGossipMenu(328, GetObjectGuid(), pPlayer); break;
                        case CLASS_PALADIN: pPlayer->GetPlayerMenu()->SendGossipMenu(1635, GetObjectGuid(), pPlayer); break;
                        case CLASS_PRIEST: pPlayer->GetPlayerMenu()->SendGossipMenu(4436, GetObjectGuid(), pPlayer); break;
                        case CLASS_ROGUE:  pPlayer->GetPlayerMenu()->SendGossipMenu(4797, GetObjectGuid(), pPlayer); break;
                        case CLASS_SHAMAN: pPlayer->GetPlayerMenu()->SendGossipMenu(5003, GetObjectGuid(), pPlayer); break;
                        case CLASS_WARLOCK: pPlayer->GetPlayerMenu()->SendGossipMenu(5836, GetObjectGuid(), pPlayer); break;
                        case CLASS_WARRIOR: pPlayer->GetPlayerMenu()->SendGossipMenu(4985, GetObjectGuid(), pPlayer); break;
                    }
                }
                return false;
            }
        ...
        case TRAINER_TYPE_PETS:
            if (pPlayer->getClass() != CLASS_HUNTER)
            {
                ...
                {
                    pPlayer->GetPlayerMenu()->ClearMenus();
                    pPlayer->GetPlayerMenu()->SendGossipMenu(3620, GetObjectGuid(), pPlayer);
                }
                return false;
            }
            break;
        case TRAINER_TYPE_MOUNTS:
            if (GetCreatureInfo()->TrainerRace && pPlayer->getRace() != GetCreatureInfo()->TrainerRace)
            {
                ...
                if (msg)
                {
                    ...
                    switch (GetCreatureInfo()->TrainerClass)
                    {
                        case RACE_DWARF:        pPlayer->GetPlayerMenu()->SendGossipMenu(5865, GetObjectGuid(), pPlayer); break;
                        case RACE_GNOME:        pPlayer->GetPlayerMenu()->SendGossipMenu(4881, GetObjectGuid(), pPlayer); break;
                        case RACE_HUMAN:        pPlayer->GetPlayerMenu()->SendGossipMenu(5861, GetObjectGuid(), pPlayer); break;
                        case RACE_NIGHTELF:     pPlayer->GetPlayerMenu()->SendGossipMenu(5862, GetObjectGuid(), pPlayer); break;
                        case RACE_ORC:          pPlayer->GetPlayerMenu()->SendGossipMenu(5863, GetObjectGuid(), pPlayer); break;
                        case RACE_TAUREN:       pPlayer->GetPlayerMenu()->SendGossipMenu(5864, GetObjectGuid(), pPlayer); break;
                        case RACE_TROLL:        pPlayer->GetPlayerMenu()->SendGossipMenu(5816, GetObjectGuid(), pPlayer); break;
                        case RACE_UNDEAD:       pPlayer->GetPlayerMenu()->SendGossipMenu(624, GetObjectGuid(), pPlayer); break;
                        case RACE_BLOODELF:     pPlayer->GetPlayerMenu()->SendGossipMenu(5862, GetObjectGuid(), pPlayer); break;
                        case RACE_DRAENEI:      pPlayer->GetPlayerMenu()->SendGossipMenu(5864, GetObjectGuid(), pPlayer); break;
                    }
                }
                return false;
            }
        ...
        case TRAINER_TYPE_TRADESKILLS:
            if (GetCreatureInfo()->TrainerSpell && !pPlayer->HasSpell(GetCreatureInfo()->TrainerSpell))
            {
                ...
                {
                    pPlayer->GetPlayerMenu()->ClearMenus();
                    pPlayer->GetPlayerMenu()->SendGossipMenu(11031, GetObjectGuid(), pPlayer);
                }
                return false;
            }
            break;
...
bool Creature::CanInteractWithBattleMaster(Player* pPlayer, bool msg) const
{
    ...
    if (!pPlayer->GetBGAccessByLevel(bgTypeId))
    {
        ...
        switch (bgTypeId)
        {
            case BATTLEGROUND_AV:  pPlayer->GetPlayerMenu()->SendGossipMenu(7616, GetObjectGuid(), pPlayer); break;
            case BATTLEGROUND_WS:  pPlayer->GetPlayerMenu()->SendGossipMenu(7599, GetObjectGuid(), pPlayer); break;
            case BATTLEGROUND_AB:  pPlayer->GetPlayerMenu()->SendGossipMenu(7642, GetObjectGuid(), pPlayer); break;
            case BATTLEGROUND_EY:
            case BATTLEGROUND_NA:
            case BATTLEGROUND_BE:
            case BATTLEGROUND_AA:
            case BATTLEGROUND_RL:  pPlayer->GetPlayerMenu()->SendGossipMenu(10024, GetObjectGuid(), pPlayer); break;
            default: break;
        }
        return false;
    }
