...
class ThreatManager
{
    public:
        ...
        void addThreat(Unit* victim, float threat, bool crit, SpellSchoolMask schoolMask, SpellEntry const* threatSpell, bool assist, bool isScaled = false, Unit * pSpellTarget = nullptr);
