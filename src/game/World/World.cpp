...
void World::LoadConfigSettings(bool reload)
{
	...
	setConfig(CONFIG_UINT32_START_PLAYER_ILEVEL, "StartPlayerILevel", 5);
    ...
    setConfig(CONFIG_BOOL_METRIC, "Metric.Enable", false);
    ...
    setConfig(CONFIG_BOOL_AUTOLEARN_ACTIVE, "AutoLearn.Active", true);

    setConfig(CONFIG_FLOAT_RATE_UPGRADE_ITEM_UNCOMMON, "BonusUpgrade.Rate.Uncommon", 1.0f);
    ...
    setConfig(CONFIG_BOOL_BONUS_UPGRADE_LOOT, "BonusUpgrade.Loot", false);
    ...
    setConfig(CONFIG_BOOL_AUTO_UPRANK,                "AutoUprank", true);
