...
void World::LoadConfigSettings(bool reload)
{
	...
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_POOR,                     "Rate.Weight.Item.Poor",                     0.5f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_NORMAL,                   "Rate.Weight.Item.Normal",                   1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_UNCOMMON,                 "Rate.Weight.Item.Uncommon",                 5.0f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_RARE,                     "Rate.Weight.Item.Rare",                     10.0f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_EPIC,                     "Rate.Weight.Item.Epic",                     15.0f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_LEGENDARY,                "Rate.Weight.Item.Legendary",                20.0f);
	setConfigPos(CONFIG_FLOAT_RATE_WEIGHT_ITEM_ARTIFACT,                 "Rate.Weight.Item.Artifact",                 25.0f);
