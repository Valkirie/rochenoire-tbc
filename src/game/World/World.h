...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_UPGRADE_ITEM_UNCOMMON,
    CONFIG_FLOAT_RATE_UPGRADE_ITEM_RARE,
    CONFIG_FLOAT_RATE_UPGRADE_ITEM_EPIC,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_AUTOLEARN_ACTIVE,
    CONFIG_BOOL_BONUS_UPGRADE_LOOT,
    CONFIG_BOOL_BONUS_UPGRADE_QUEST,
    CONFIG_BOOL_BONUS_UPGRADE_CRAFTING,
    CONFIG_BOOL_METRIC,
