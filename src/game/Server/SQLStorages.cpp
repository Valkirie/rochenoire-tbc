...
const char CreatureDataAddonInfofmt[] = "iiiibbiis";
...
const char CreatureInfoAddonInfofmt[] = "iiiibbiis";
...
const char InstanceTemplatesrcfmt[] = "iiiiiiiisl";
const char InstanceTemplatedstfmt[] = "iiiiiiiiil";
