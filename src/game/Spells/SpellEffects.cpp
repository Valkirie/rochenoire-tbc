        ...
        case SPELLFAMILY_GENERIC:
        {
            switch (m_spellInfo->Id)
            {
                ...
                case 21108:                                 // Summon Sons of Flame
                {
                    ...
                    uint32 m_uiAddCount = ((DungeonMap*)m_caster->GetMap())->GetFinalNAdds(m_caster->GetInstanceTanks(), 8);
                ...
                case 41333:                                 // Empyreal Equivalency
                {
                    ...
                    uint32 targets = ((DungeonMap*)unitTarget->GetMap())->GetFinalNAdds(unitTarget->GetInstanceTanks(), 4);
...
void Spell::EffectApplyAura(SpellEffectIndex eff_idx)
{
    ...
    aur->GetModifier()->m_scaled = IsScaledForTarget(unitTarget->GetGUIDLow(), eff_idx);
    ...
    else
    {
        ...
        switch (m_spellInfo->Id)
        {
            ...
            case 41915:                    // summons 02 parasitic shadowfiends
                amount = ((DungeonMap*)m_caster->GetMap())->GetFinalNAdds(m_caster->GetInstanceTanks(), damage);
                break;
        }
    }
...
void Spell::EffectPickPocket(SpellEffectIndex /*eff_idx*/)
{
    ...
    int casterLevel = int32(m_caster->GetLevelForTarget(unitTarget));
    int targetLevel = int32(unitTarget->GetLevelForTarget(m_caster));
...
void Spell::EffectTameCreature(SpellEffectIndex /*eff_idx*/)
{
    ...
    uint32 level = creatureTarget->GetLevelForTarget(plr);
