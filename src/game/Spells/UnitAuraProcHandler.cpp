    ...
    switch (dummySpell->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_PRIEST:
        {
            ...
            if (dummySpell->SpellFamilyFlags & uint64(0x0000040000000000))
            {
                ...
                pVictim->CastCustomSpell(pVictim, 34919, &basepoints[0], nullptr, nullptr, TRIGGERED_IGNORE_GCD | TRIGGERED_IGNORE_CURRENT_CASTED_SPELL | TRIGGERED_HIDE_CAST_IN_COMBAT_LOG, castItem, triggeredByAura);
            ...
            switch (dummySpell->Id)
            {
                ...
                case 15286:
                {
                    ...
                    // heal amount
                    basepoints[0] = triggerAmount * olddamage / 100;
                    pVictim->CastCustomSpell(pVictim, 15290, &basepoints[0], nullptr, nullptr, TRIGGERED_IGNORE_GCD | TRIGGERED_IGNORE_CURRENT_CASTED_SPELL | TRIGGERED_HIDE_CAST_IN_COMBAT_LOG, castItem, triggeredByAura);
                    return SPELL_AURA_PROC_OK;              // no hidden cooldown
                }
